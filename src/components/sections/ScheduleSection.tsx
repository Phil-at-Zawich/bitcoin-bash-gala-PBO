...
const ScheduleSection = () => {
  const scheduleData = {
    day1: [
      { time: "08:00 - 09:30", title: "Registration & Breakfast", description: "Welcome coffee and networking" },
      { time: "09:30 - 10:30", title: "Opening Keynote", description: "The Future of Bitcoin: Challenges and Opportunities" },
      { time: "10:45 - 12:00", title: "Panel Discussion", description: "Institutional Adoption: The Path Forward" },
      { time: "12:00 - 13:30", title: "Lunch Break", description: "Gourmet lunch and networking" },
      { time: "13:30 - 15:00", title: "Technical Workshops", description: "Lightning Network: Building the Future of Payments" },
      { time: "15:15 - 16:30", title: "Fireside Chat", description: "Bitcoin's Role in a Changing Global Economy" },
      { time: "17:00 - 19:00", title: "Welcome Reception", description: "Cocktails and hors d'oeuvres" },
    ],
    day2: [
    ...
    <section id="schedule" className="section bg-white">
      <div className="container mx-auto">
        <SectionTitle 
          ...
          title="Three Days of Inspiring Content"
        />
          ...
          <Tabs defaultValue="day1" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-12">
              <TabsTrigger value="day1" className="text-base py-3">
                <span className="hidden md:inline mr-2">Day 1:</span> December 15
              </TabsTrigger>
              <TabsTrigger value="day2" className="text-base py-3">
                <span className="hidden md:inline mr-2">Day 2:</span> December 16
              </TabsTrigger>
              <TabsTrigger value="day3" className="text-base py-3">
                <span className="hidden md:inline mr-2">Day 3:</span> December 17
              </TabsTrigger>
            </TabsList>
