        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionTitle 
              ...
              title="Experience the Historic Grand Palace Hotel"
              alignment="left"
            ...
            <div className="fade-in-section mb-8">
              ...
              <p className="text-white/90 text-lg mb-6">
                Nestled in the heart of the historic city center, the Grand Palace Hotel combines timeless elegance with modern luxury, providing the perfect backdrop for our exclusive Bitcoin Summit.
              </p>
              
              <p className="text-white/90 text-lg mb-8">
                With stunning architecture, world-class amenities, and impeccable service, the venue offers an unparalleled experience for our distinguished guests.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">Luxurious Accommodations</h3>
                    <p className="text-white/80">Elegant rooms and suites with premium amenities</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">Located in the historic center, surrounded by cultural landmarks</p>
                  </div>
                </div>
              </div>
            </div>
