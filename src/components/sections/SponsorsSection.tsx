...
const Sponsor: React.FC<SponsorProps> = ({
  ...
  return (
    <div
      className={`fade-in-section bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group col-span-3 md:col-span-${span}`}
    ...
    >
      ...
      >
        <img
          src={image}
          alt={name}
          className="w-auto m-auto h-full object-cover object-center group-hover:scale-105 transition-transform duration-500"
        />
      </div>
      <div className="p-6">
