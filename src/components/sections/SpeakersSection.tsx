...
const Speaker: React.FC<SpeakerProps> = ({ name, role, company, image, delay }) => {
  return (
    <div className={`fade-in-section bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group`} style={{ animationDelay: `${delay * 100}ms` }}>
...
const SpeakersSection = () => {
  const speakers = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1619085888250-b7691f3d5fe9?q=80&w=1974&auto=format&fit=crop"
    },
    {
      name: "James Wilson",
  ...
  return (
    <section id="speakers" className="section bg-gray-50">
      <div className="container mx-auto">
        <SectionTitle 
          subtitle="World-Class Speakers" 
          title="Learn from the Bitcoin Elite"
        />
